...
🔥 This is the second part of the series ["Full CI/CD workflow with Skaffold for your application"](https://blog.equationlabs.io/series/workflow-with-skaffold).
...
### Feature Branches Workflow (trigger by merge\_request commit):
